...
ENABLE_HYDE = True
HYDE_FOR_SIMPLE_QUERIES = True  # Only use HyDE for complex queries
...
# Master memory toggle (add this line)
ENABLE_MEMORY = True
...
# Validation LLM Provider
VALIDATOR_LLM = os.getenv("VALIDATOR_LLM", "azure")  # "gemini" or "azure"

# Gemini Configuration (for validation)
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "")
GEMINI_MODEL = os.getenv("GEMINI_MODEL", "gemini-2.5-flash")  # Fast & cheap
GEMINI_TEMPERATURE = float(os.getenv("GEMINI_TEMPERATURE", "0.1"))
GEMINI_MAX_TOKENS = int(os.getenv("GEMINI_MAX_TOKENS", "1500"))

# Azure Configuration (for validation - if VALIDATOR_LLM="azure")
AZURE_VALIDATOR_DEPLOYMENT = os.getenv("AZURE_VALIDATOR_DEPLOYMENT", "gpt-4o-mini")
# Note: Uses existing AZURE_OPENAI_ENDPOINT, AZURE_OPENAI_KEY, AZURE_OPENAI_API_VERSION

# Validation Thresholds
VALIDATION_SCORE_THRESHOLD = int(os.getenv("VALIDATION_SCORE_THRESHOLD", "32"))  # Out of 40 (80%)
SKIP_VALIDATION_FOR_HIGH_CONFIDENCE = os.getenv("SKIP_VALIDATION_FOR_HIGH_CONFIDENCE", "True").lower() == "true"
...
# Healing Retries
HEALING_MAX_RETRIES = int(os.getenv("HEALING_MAX_RETRIES", "1"))  # One healing attempt

# Healing Strategies (for reference - used in self_healing_agent.py)
HEALING_STRATEGIES = [
